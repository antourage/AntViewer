...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ViewerExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15ViewerExtension9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(ViewerExtension))
...
SWIFT_PROTOCOL("_TtP15ViewerExtension17WebSocketDelegate_")
@protocol WebSocketDelegate
