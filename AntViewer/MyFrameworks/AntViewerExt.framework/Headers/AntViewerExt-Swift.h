...
#ifndef ANTVIEWEREXT_SWIFT_H
#define ANTVIEWEREXT_SWIFT_H
...
SWIFT_CLASS("_TtC12AntViewerExt9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(AntViewerExt))
...
SWIFT_PROTOCOL("_TtP12AntViewerExt17WebSocketDelegate_")
@protocol WebSocketDelegate
